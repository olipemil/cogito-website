...
<div style="display: flex;">
    <div style="width: 300px; height: 400px;">
        <img src="{{ site.baseurl }}/docs/Si/SiprojectedDOS.png" alt="Image 2" style="width: 90%; height: 95%; border: 0;">
    </div>
    <div style="width: 250px; height: 400px;">
        <img src="{{ site.baseurl }}/docs/Si/COHP_DOS.png" alt="Image 2" style="width: 90%; height: 95%; border: 0;">
    </div>
</div>
